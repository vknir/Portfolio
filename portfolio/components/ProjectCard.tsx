...
export default function ProjectCard(props: IProjectCardProps) {
  return (
    <div className="flex flex-col justify-between gap-2 w-full max-w-[400px] h-80 max-h-80 text-left">
      ...
      <div className="flex flex-col justify-center">
        ...
        <div className="rounded-b-xl bg-gray-950 p-5 flex flex-col gap-4">
          {props.description}
